...
class Generate extends Regex
{
  ...
  {
    $files = array_merge(glob(__DIR__ . '/../../../../resources/views/*php'), glob(__DIR__ . '/../../../../resources/views/**/*php'), glob(__DIR__ . '/../../../../resources/views/**/**/*php'), glob(__DIR__ . '/../../../../resources/views/**/**/**/*php'), glob(__DIR__ . '/../../../../resources/views/**/**/**/**/*php'));

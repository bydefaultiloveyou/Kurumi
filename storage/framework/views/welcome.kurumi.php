<?php $__deus->startContent("layouts") ?><?php $__comp->extendContent("header","title") ?>
...
<?php $__comp->extendContent("footer",) ?>

<?php $__deus->stopContent() ?>

<?php $__deus->extendContent("layouts.main") ?>